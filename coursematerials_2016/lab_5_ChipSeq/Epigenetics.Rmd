...
extended regions of high coverage. Finally, ChIP-seq with antibodies
...
```{r Aver_plot}
## saves the plot to disk as "final_plot.png"
## you may have to edit the path variable to suit your own path or project structure

path <- c("./coursematerials_2016/lab_5_ChipSeq/")

png(filename = paste0(path, "final_plot.png"), width = 4000, height = 3000, res = 280)
