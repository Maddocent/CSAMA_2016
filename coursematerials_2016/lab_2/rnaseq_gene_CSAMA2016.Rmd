...
vignette: |
  %\VignetteIndexEntry{RNA-seq workflow at the gene level} %\VignetteEngine{knitr::rmarkdown}
---
...
#######################################################################
on Windows machines: SKIP THE CHUNK BELOW
#######################################################################
#```{r}
#library("Rsubread")
...
#################################################################################
# IMPORTANT DATA LABELLING STEP BELOW:
...
Euclidean (*as the birds fly*) distance.
